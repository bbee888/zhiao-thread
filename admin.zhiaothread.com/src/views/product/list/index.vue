<template>
  <div class="page-container">
    <el-card class="page-search" shadow="never">
      <el-form ref="queryFormRef" :model="queryParams" :inline="true">
        ...
        <el-form-item label="关键字" prop="keywords">
          <el-input v-model="queryParams.keywords" placeholder="产品名称" @keyup.enter="handleQuery" />
        </el-form-item>
    ...
    <el-dialog v-model="dialogState.visible" :title="dialogState.title" width="70%" @closed="closeDialog" top="10px">
      <el-form ref="productFormRef" :model="formData" :rules="rules" label-width="100px">
        <el-form-item label="产品分类" prop="cateId">
...
function getLangData(code: string): any {
  if (!formData.langData[code] || typeof formData.langData[code] !== 'object') {
    formData.langData[code] = { title: "", content: "", color: "", length: "", tenacity: "", keywords: "", description: "" };
  }

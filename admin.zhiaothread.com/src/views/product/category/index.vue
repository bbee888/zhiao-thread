<template>
  <div class="page-container">
    ...
    <el-card class="page-content" shadow="never">
      ...
      top="6vh"
      width="70%"
      custom-class="product-category-dialog"
      @close="closeDialog"
    >
      <template #header>
...
defineOptions({ name: "ProductCategory", inheritAttrs: false });
...
function handleSubmit() {
  categoryFormRef.value?.validate(async (valid) => {
    console.log('[前端] 表单验证结果:', valid);
    console.log('[前端] 准备发送的数据:', JSON.stringify(formData, null, 2));
